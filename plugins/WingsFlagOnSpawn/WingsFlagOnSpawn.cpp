...
class WingsFlagOnSpawn : public bz_Plugin
{
public:
...
BZ_PLUGIN(WingsFlagOnSpawn)

const char* WingsFlagOnSpawn::Name()
{
	return "Wings Flag On Spawn";
}

void WingsFlagOnSpawn::Init(const char*)
{
	Register(bz_ePlayerSpawnEvent);
}

void WingsFlagOnSpawn::Cleanup()
{
	Flush();
}

void WingsFlagOnSpawn::Event(bz_EventData* eventData)
{
	switch (eventData->eventType)
	{
		case bz_ePlayerSpawnEvent:
		{
			...
			bz_givePlayerFlag(data->playerID, "WG", true);
