BZFlag Server Plugin: genostats
================================================================================
...
genostats directory to a new name, and then manually replace genostats
...
To load the plugin with specific settings, use the format:
  -loadplugin genostats,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin genostats,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin genostats,<configfilename>
For example:
  -loadplugin genostats,/path/to/my/sampleplugin.cfg
