BZFlag Server Plugin: spawnFacingCenter
================================================================================
...
spawnFacingCenter directory to a new name, and then manually replace spawnFacingCenter
...
To load the plugin with specific settings, use the format:
  -loadplugin spawnFacingCenter,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin spawnFacingCenter,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin spawnFacingCenter,<configfilename>
For example:
  -loadplugin spawnFacingCenter,/path/to/my/sampleplugin.cfg
