...
Kamikaze directory to a new name, and then manually replace Kamikaze
...
To load the plugin with specific settings, use the format:
  -loadplugin Kamikaze,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin Kamikaze,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin Kamikaze,<configfilename>
For example:
  -loadplugin Kamikaze,/path/to/my/sampleplugin.cfg
