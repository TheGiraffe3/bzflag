BZFlag Server Plugin: DeathBlossomFlag
================================================================================
...
DeathBlossomFlag directory to a new name, and then manually replace DeathBlossomFlag
...
To load the plugin with specific settings, use the format:
  -loadplugin DeathBlossomFlag,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin DeathBlossomFlag,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin DeathBlossomFlag,<configfilename>
For example:
  -loadplugin DeathBlossomFlag,/path/to/my/sampleplugin.cfg
