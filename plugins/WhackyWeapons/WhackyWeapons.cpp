	...
	public:
		...
		virtual void Init(char const* /*config*/) override {
...

			{
				...
				//Lightning Bolt (LB)
				bz_RegisterCustomFlag("LB", "Lightning Bolt", "Shooting triggers a lightning bolt. Don't stay still when firing, or you'll hit yourself!", 0, eGoodFlag);
				...
				bz_RegisterCustomFlag("NC", "Nyan Cat", "Tank uncontrollably spews rainbow bullets backward, and can't fire forward.", 0, eBadFlag);
