BZFlag Server Plugin: uselessGeno
================================================================================
...
uselessGeno directory to a new name, and then manually replace uselessGeno
...
To load the plugin with specific settings, use the format:
  -loadplugin uselessGeno,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin uselessGeno,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin uselessGeno,<configfilename>
For example:
  -loadplugin uselessGeno,/path/to/my/sampleplugin.cfg
