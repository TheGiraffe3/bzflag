...
genoonce directory to a new name, and then manually replace genoonce
...
To load the plugin with specific settings, use the format:
  -loadplugin genoonce,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin genoonce,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin genoonce,<configfilename>
For example:
  -loadplugin genoonce,/path/to/my/sampleplugin.cfg
