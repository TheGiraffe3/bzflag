BZFlag Server Plugin: PointLessSelfKills
================================================================================
...
PointLessSelfKills directory to a new name, and then manually replace PointLessSelfKills
...
To load the plugin with specific settings, use the format:
  -loadplugin PointLessSelfKills,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin PointLessSelfKills,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin PointLessSelfKills,<configfilename>
For example:
  -loadplugin PointLessSelfKills,/path/to/my/sampleplugin.cfg
