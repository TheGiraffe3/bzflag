BZFlag Server Plugin: NoLossOnSW
================================================================================
...
NoLossOnSW directory to a new name, and then manually replace NoLossOnSW
...
To load the plugin with specific settings, use the format:
  -loadplugin NoLossOnSW,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin NoLossOnSW,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin NoLossOnSW,<configfilename>
For example:
  -loadplugin NoLossOnSW,/path/to/my/sampleplugin.cfg
