BZFlag Server Plugin: doublePoint
================================================================================
...
doublePoint directory to a new name, and then manually replace doublePoint
...
To load the plugin with specific settings, use the format:
  -loadplugin doublePoint,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin doublePoint,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin doublePoint,<configfilename>
For example:
  -loadplugin doublePoint,/path/to/my/sampleplugin.cfg
