BZFlag Server Plugin: riskygeno
================================================================================
...
riskygeno directory to a new name, and then manually replace riskygeno
...
To load the plugin with specific settings, use the format:
  -loadplugin riskygeno,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin riskygeno,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin riskygeno,<configfilename>
For example:
  -loadplugin riskygeno,/path/to/my/sampleplugin.cfg
